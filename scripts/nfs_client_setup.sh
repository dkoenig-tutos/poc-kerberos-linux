...
# Authenticating as principal host/admin@DKOENIG.INFRA with password.
# kadmin: Client 'host/admin@DKOENIG.INFRA' not found in Kerberos database while initializing kadmin interface
...
# showmount -e nfs-storage.dkoenig.infra
# mount -t nfs nfs-storage.dkoenig.infra:/nfs/export_rw /mnt/backups
